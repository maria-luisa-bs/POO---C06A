...
import br.inatel.pedido.Pedido;
...
public class Main {
    public static void main(String[] args)
    {
        ...
        // instanciando a loja (vai criar os computadores disponíveis)
        Loja loja = new Loja();

        // computadores disponíveis
        Computador[] computadors = loja.getComputadors();
        ...
        do{
            ...
            System.out.println("Modelo 1: Dell");
            System.out.println("Modelo 2: Aplle");
            System.out.println("Modelo 3: Samsung");
            ...
            switch (op)
            {
                ...
                case 3:
                    ...
                    System.out.println("Computador modelo Samsung foi adicionado ao seu carrinh!\n");
                    break;
                case 0:
        ...
        Pedido.pedido(cliente.getComputadores());
    }
}
